		...
		<form action="<?php echo esc_url( admin_url( 'options.php' ) ); ?>" method="post">
			...
			<table class="form-table">
				...
				<tr valign="top">
					...
					<td>
					<textarea rows="4" cols="100" name="<?php echo esc_attr( $this->option_name ); ?>[mincomlengtherror]"
			...
			<p><?php printf( __( 'This plugin adds an "E-mail" action link on the comments overview page as well as an email all commenters button (%s) on individual post pages in the admin bar. You can customize the default messages here.', 'yoast-comment-hacks' ), '<span class="dashicons dashicons-email-alt"></span>' ); ?></p>
			<table class="form-table">
				<tr>
					...
					<td>
						<input type="text" name="<?php echo esc_attr( $this->option_name ); ?>[email_subject]"
						       id="email_subject" value="<?php echo esc_attr( $this->options['email_subject'] ); ?>"/>
					</td>
				</tr>
				<tr>
					<th scope="row" valign="top">
				...
				<tr>
					<th scope="row" valign="top">
						<label for="mass_email_body"><?php _e( 'E-mail all commenters body', 'yoast-comment-hacks' ); ?></label>
					</th>
					<td>
