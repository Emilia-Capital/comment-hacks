            ...
            <div id="forward-emails" class="yoasttab">
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label
                                    for="forward-emails-email"><?php esc_html_e( 'Forward email to', 'yoast-comment-hacks' ); ?></label>
                        </th>
                        <td><input type="email" id="forward-emails-email" class="regular-text"
                                   ...
                                   value="<?php esc_attr_e( $this->options['forward_email'] ); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                        ...
                        <td><input type="text" id="forward-emails-name" class="regular-text"
                                   ...
                                   value="<?php esc_attr_e( $this->options['forward_name'] ); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label
                                    for="forward-emails-from-email"><?php esc_html_e( 'Forward "From" email address', 'yoast-comment-hacks' ); ?></label>
                        </th>
                        <td><input type="email" id="forward-emails-from-email" class="regular-text"
                                   ...
                                   value="<?php esc_attr_e( $this->options['forward_from_email'] ); ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                        ...
                        <td><input type="text" id="forward-emails-subject" class="regular-text"
                                   ...
                                   value="<?php esc_attr_e( $this->options['forward_subject'] ); ?>"/>
                        </td>
                    </tr>
                </table>
            </div>
